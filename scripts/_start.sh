...
sudo ln -s /usr/share/nginx/init/php.ini /etc/php5/fpm/php.ini

# Set Xdebug settings for Vagrant
sudo rm /etc/php5/mods-available/xdebug.ini
sudo ln -s /usr/share/nginx/init/xdebug.ini /etc/php5/mods-available/xdebug.ini

# Set XHProf settings for Vagrant
sudo rm /etc/php5/mods-available/xhprof.ini
sudo ln -s /usr/share/nginx/init/xhprof.ini /etc/php5/mods-available/xhprof.ini
